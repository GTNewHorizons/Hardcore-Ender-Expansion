...
public final class KnowledgeRegistrations {
    ...
    public static final KnowledgeObject<? extends IKnowledgeObjectInstance<?>> HELP = new KnowledgeObject<>(
            new ObjectDummy("HalpPlz")),

            // ===

            STRONGHOLD = dummy("Stronghold", new ItemStack(Blocks.stonebrick), "ec.title.stronghold"),
            ADVENTURERS_DIARY = create(ItemList.adventurers_diary), ENDERMAN_HEAD = create(ItemList.enderman_head),
            MUSIC_DISKS = create(ItemList.music_disk), END_PORTAL = create(Blocks.end_portal_frame, "ec.title.portal"),
            ALTAR_NEXUS = create(ItemList.altar_nexus),
            BASIC_ESSENCE_ALTAR = create(BlockList.essence_altar, EssenceType.INVALID.id),
            ENDERMAN = create(EntityMobEnderman.class), SILVERFISH = create(EntitySilverfish.class),
            ...
            END_STONE = create(Blocks.end_stone), FALLING_OBSIDIAN = create(BlockList.obsidian_falling),
            DRAGON_ESSENCE_ALTAR = create(BlockList.essence_altar, EssenceType.DRAGON.id),
            END_POWDER_ORE = create(BlockList.end_powder_ore),
            ENHANCED_BREWING_STAND = create(ItemList.enhanced_brewing_stand), DRAGON_EGG = create(Blocks.dragon_egg),
            DRAGON_ESSENCE = link(
                    ESSENCE,
                    new ItemStack(ItemList.essence, EssenceType.DRAGON.getItemDamage()),
                    "ec.title.essence"),
            END_POWDER = create(ItemList.end_powder), TEMPLE_CALLER = create(ItemList.temple_caller),
            ENDER_DRAGON = new KnowledgeObject<>(
                    new ObjectMob(EntityBossDragon.class),
                    new ItemStack(Blocks.dragon_egg),
                    "ec.title.enderDragon"),
            ANGRY_ENDERMAN = create(EntityMobAngryEnderman.class), VAMPIRE_BAT = create(EntityMobVampiricBat.class),

            ENDER_PEARL_ENHANCEMENTS = dummy(
                    "Enhancements.EnderPearl",
                    new ItemStack(Items.ender_pearl),
                    "ec.title.enh.enderPearl"),
            ESSENCE_ALTAR_ENHANCEMENTS = dummy(
                    "Enhancements.EssenceAltar",
                    new ItemStack(BlockList.essence_altar),
                    "ec.title.enh.essenceAltar"),
            ENHANCED_BREWING_STAND_ENHANCEMENTS = dummy(
                    "Enhancements.EnhancedBrewingStand",
                    new ItemStack(ItemList.enhanced_brewing_stand),
                    "ec.title.enh.enhancedBrewingStand"),
            TNT_ENHANCEMENTS = dummy("Enhancements.TNT", new ItemStack(Blocks.tnt), "ec.title.enh.tnt"),
            SPATIAL_DASH_GEM_ENHANCEMENTS = dummy(
                    "Enhancements.SpatialDashGem",
                    new ItemStack(ItemList.spatial_dash_gem),
                    "ec.title.enh.spatialDashGem"),
            TRANSFERENCE_GEM_ENHANCEMENTS = dummy(
                    "Enhancements.TransferenceGem",
                    new ItemStack(ItemList.transference_gem),
                    "ec.title.enh.transferenceGem"),

            // ===

            ENDSTONE_BLOB = dummy("EndstoneBlob", new ItemStack(Blocks.end_stone), "ec.title.endstoneBlob"),
            IGNEOUS_ROCK_ORE = create(BlockList.igneous_rock_ore), DEATH_FLOWER = create(BlockList.death_flower),
            ENDER_GOO = create(ItemList.bucket_ender_goo), IGNEOUS_ROCK = create(ItemList.igneous_rock),
            ...
            DUNGEON_TOWER = dummy(
                    "DungeonTower",
                    new ItemStack(BlockList.obsidian_special, 1),
                    "ec.title.dungeonTower"),
            ...
            ENERGY = create(BlockList.energy_cluster, "Energy"), ENDIUM_ORE = create(BlockList.endium_ore),
            ENDIUM_BLOCK = create(BlockList.endium_block), VOID_CHEST = create(BlockList.void_chest),
            SPATIAL_DASH_GEM = create(ItemList.spatial_dash_gem), ENDIUM_INGOT = create(ItemList.endium_ingot),
            BIOME_COMPASS = create(ItemList.biome_compass), ENDER_EYE = create(EntityMiniBossEnderEye.class),
            ...
            SPHALERITE = create(BlockList.sphalerite, 0), SPHALERITE_WITH_STARDUST = create(BlockList.sphalerite, 1),
            ...
            BIOME_ISLANDS = dummy(
                    "BiomeIslands",
                    new ItemStack(BlockList.special_effects, 1, BlockSpecialEffects.metaBiomeIslandIcon),
                    "ec.title.biomeIslands"),
            INSTABILITY_ORB_ORE = create(BlockList.instability_orb_ore), STARDUST_ORE = create(BlockList.stardust_ore),
            INSTABILITY_ORB = create(ItemList.instability_orb),
            POTION_OF_INSTABILITY = create(ItemList.potion_of_instability), STARDUST_LINKED = link(STARDUST),
            ...
            INFESTED_FOREST_BIOME = dummy(
                    "InfestedForest",
                    new ItemStack(BlockList.end_terrain, 1, BlockEndstoneTerrain.metaInfested),
                    "ec.title.biome.infestedForest"),
            ...
            INFESTATION_REMEDY = create(ItemList.infestation_remedy), INFESTED_BAT = create(EntityMobInfestedBat.class),
            SILVERFISH_LINKED = link(SILVERFISH),

            THORNY_BUSH = create(BlockList.crossed_decoration, BlockCrossedDecoration.dataThornBush),
            SPOOKY_LOG = create(BlockList.spooky_log), SPOOKY_LEAVES = create(BlockList.spooky_leaves),
            DRY_SPLINTER = create(ItemList.dry_splinter),
            GHOST_AMULET = create(ItemList.ghost_amulet, "ec.title.ghostAmulet"),
            ECTOPLASM = create(ItemList.ectoplasm), SPECTRAL_TEAR = create(ItemList.spectral_tear),
            LIVING_MATTER = create(ItemList.living_matter), CURSE = create(ItemList.curse, "ec.title.curses"),
            POTION_OF_PURITY = create(ItemList.potion_of_purity), CURSE_AMULET = create(ItemList.curse_amulet),

            RAVAGED_DUNGEON = dummy(
                    "RavagedDungeon",
                    new ItemStack(BlockList.ravaged_brick),
                    "ec.title.ravagedDungeon"),
            ...
            RAVAGED_BRICK_FENCE = create(BlockList.ravaged_brick_fence), CHARM_POUCH = create(ItemList.charm_pouch),
            RUNES = create(ItemList.rune, "Runes"), CHARMS = create(ItemList.charm, "Charms"),
            LOUSE = create(EntityMobLouse.class),

            // ===

            BURNING_MOUNTAINS_BIOME = dummy(
                    "BurningMountains",
                    new ItemStack(BlockList.end_terrain, 1, BlockEndstoneTerrain.metaBurned),
                    "ec.title.biome.burningMountains"),
            ...
            IGNEOUS_ROCK_ORE_LINKED = link(IGNEOUS_ROCK_ORE), IGNEOUS_ROCK_LINKED = link(IGNEOUS_ROCK),
            ...
            FIERY_ESSENCE = link(
                    ESSENCE,
                    new ItemStack(ItemList.essence, 1, EssenceType.FIERY.getItemDamage()),
                    "ec.title.essence"),
            FIRE_GOLEM = create(EntityMobFireGolem.class), SCORCHING_LENS = create(EntityMobScorchingLens.class),
            FIRE_FIEND = create(EntityMiniBossFireFiend.class),

            INFERNIUM = create(ItemList.infernium), SCORCHING_PICKAXE = create(ItemList.scorching_pickaxe),
            HAUNTED_MINER = create(EntityMobHauntedMiner.class),

            // ===

            ENCHANTED_ISLAND_BIOME = dummy(
                    "EnchantedIsland",
                    new ItemStack(BlockList.end_terrain, 1, BlockEndstoneTerrain.metaEnchanted),
                    "ec.title.biome.enchantedIsland"),
            ENCHANTED_END_STONE = create(BlockList.end_terrain, 2),

            FALLING_OBSIDIAN_LINKED = link(FALLING_OBSIDIAN), PERSEGRIT = create(BlockList.persegrit),
            ENDERMAN_LINKED = link(ENDERMAN),

            ARCANE_SHARD = create(ItemList.arcane_shard), BLANK_GEM = create(ItemList.blank_gem),
            SPATIAL_DASH_GEM_LINKED = link(SPATIAL_DASH_GEM), TRANSFERENCE_GEM = create(ItemList.transference_gem),
            ...
            OBSIDIAN_FRAGMENT = create(ItemList.obsidian_fragment), OBSIDIAN_ROD = create(ItemList.obsidian_rod),
            AURICION = create(ItemList.auricion), ENERGY_WAND_CORE = create(ItemList.energy_wand_core),
            ENERGY_WAND = create(ItemList.energy_wand), ENDER_GUARDIAN = create(EntityMobEnderGuardian.class),
    ...
    public static void initialize() {
        ...
        /*
         * General information =================== Numbers below are not set in stone, they will vary a bit around that
         * value but keep the meaning. Object price ============ early | mid | late | description
         * ------+-----+------+------------ 5 | 7 | 10 | easily found objects without any feature mechanics 8 | 10 | 15
         * | easily found objects with some mechanics 12 | 15 | 25 | basic objects with mechanics 20 | 25 | 35 |
         * important objects with mechanics 30 | 40 | 50 | major objects 40 | 75 | 100 | phase objects (might vary)
         * Fragment price ============== early | mid | late | description ------+-----+------+------------ 1 | 2 | 3 |
         * bulk data 2 | 4 | 6 | unimportant or generic information 3 | 5 | 8 | semi-important or additional information
         * 5 | 7 | 10 | basic information about important objects 8 | 10 | 15 | important and key information Game
         * phases =========== early - overworld, dragon lair, endstone blobs, dungeon tower mid - meteoroids, biome
         * islands late - Object discovery reward ======================= Most objects should give enough points to
         * unlock some/all fragments. Uncommon and rare objects should give an additional bonus. Purely visual objects
         * should also give a small bonus for discovery. Objects which are made in a way they should be unlocked with
         * points would only give small reward.
         */

        HELP.setNonBuyable().addFragments(
                new KnowledgeFragment[] { new KnowledgeFragmentText(0), new KnowledgeFragmentText(1),
                        new KnowledgeFragmentText(2), new KnowledgeFragmentText(3), new KnowledgeFragmentText(4),
                        new KnowledgeFragmentText(5), new KnowledgeFragmentText(6), new KnowledgeFragmentText(7),
                        new KnowledgeFragmentText(8), new KnowledgeFragmentText(9), new KnowledgeFragmentText(18) });

        if (Loader.isModLoaded("NotEnoughItems")) {
            HELP.addFragments(new KnowledgeFragment[] { new KnowledgeFragmentText(19) });
        }

        ESSENCE.setNonBuyable().setDiscoveryReward(12).addFragments(
                new KnowledgeFragment[] { new KnowledgeFragmentText(80).setPrice(2).setUnlockOnDiscovery(),
        ...
        KnowledgeCategories.OVERWORLD.addKnowledgeObjects(
                new KnowledgeObject[] {
                        STRONGHOLD.setCategoryObject(KnowledgeCategories.OVERWORLD).setUnlockPrice(5)
                                .setDiscoveryReward(10).addFragments(
                                        new KnowledgeFragment[] {
                                                ...
                                                new KnowledgeFragmentText(713).setPrice(3)
                                                        .setUnlockRequirements(712) }),

                        ADVENTURERS_DIARY.setPos(0, 0).setUnlockPrice(5).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(10).setPrice(2).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(11).setPrice(2).setUnlockOnDiscovery() }),

                        ENDERMAN_HEAD.setPos(2, 0).setUnlockPrice(5).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        MUSIC_DISKS.setPos(4, 0).setUnlockPrice(5).setDiscoveryReward(5)
                                .addFragments(new KnowledgeFragment[] { new KnowledgeFragmentText(30).setPrice(2) }),

                        END_PORTAL.setPos(2, 6).setNonBuyable().setDiscoveryReward(28).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        ALTAR_NEXUS.setPos(1, 9).setUnlockPrice(10).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] { new KnowledgeFragmentText(40).setPrice(8),
                                        new KnowledgeFragmentCrafting(41).setRecipe(new ItemStack(ItemList.altar_nexus))
                                                .setPrice(5).setUnlockRequirements(40),
                                        new KnowledgeFragmentCrafting(42)
                                                .setRecipe(new ItemStack(BlockList.essence_altar)).setPrice(8)
                                                .setUnlockCascade(50) }),
                        ...
                        BASIC_ESSENCE_ALTAR
                                .setPos(
                                        3,
                                        9)
                                .setNonBuyable().setDiscoveryReward(20).addFragments(
                                        new KnowledgeFragment[] {
                                                new KnowledgeFragmentCrafting(50)
                                                        .setRecipe(new ItemStack(BlockList.essence_altar)).setPrice(8)
                                                        .setUnlockCascade(42),
                                                new KnowledgeFragmentText(51).setUnlockOnDiscovery().setPrice(5)
                                                        .setUnlockRequirements(50),
                                                new KnowledgeFragmentText(52).setPrice(2).setUnlockRequirements(51) }),

                        ENDERMAN.setPos(1, 3).setUnlockPrice(5).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        SILVERFISH.setPos(3, 3).setUnlockPrice(5).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
        ...
        KnowledgeCategories.DRAGON_LAIR.addKnowledgeObjects(
                new KnowledgeObject[] {
                        DRAGON_LAIR.setCategoryObject(KnowledgeCategories.DRAGON_LAIR).setUnlockPrice(45)
                                .setDiscoveryReward(15).addFragments(
                                        new KnowledgeFragment[] { new KnowledgeFragmentText(750).setPrice(5),
                                                new KnowledgeFragmentText(751).setPrice(2).setUnlockRequirements(750)
                                                        .setUnlockCascade(191),
                                                ...
                                                new KnowledgeFragmentText(755).setPrice(2)
                                                        .setUnlockRequirements(752) }),

                        END_STONE.setPos(0, 0).setUnlockPrice(5).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(90).setPrice(2).setUnlockOnDiscovery() }),

                        FALLING_OBSIDIAN.setPos(2, 0).setUnlockPrice(8).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        DRAGON_ESSENCE_ALTAR.setPos(3, 10).setUnlockPrice(25).setDiscoveryReward(22).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentItemConversion(115)
                                                .setItems(
                                                        new ItemStack(Items.brewing_stand),
                                                        new ItemStack(ItemList.enhanced_brewing_stand))
                                                .setPrice(3).setUnlockRequirements(114).setUnlockCascade(130),
                                        new KnowledgeFragmentItemConversion(116)
                                                .setItems(
                                                        new ItemStack(Items.ender_eye),
                                                        new ItemStack(ItemList.temple_caller))
                                                .setNonBuyableRedirect(TEMPLE_CALLER), // 180
                                        new KnowledgeFragmentItemConversion(117)
                                                .setItems(
                                                        new ItemStack(ItemList.ghost_amulet),
                                                        new ItemStack(ItemList.ghost_amulet, 1, 1))
                                                .setNonBuyableRedirect(GHOST_AMULET), // 463
                                }),

                        END_POWDER_ORE.setPos(6, 0).setUnlockPrice(15).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(120).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(121).setPrice(2).setUnlockOnDiscovery()
                                                .setUnlockRequirements(120),
                        ...
                        ENHANCED_BREWING_STAND.setPos(4, 12).setUnlockPrice(18).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentText(132).setPrice(5).setUnlockRequirements(130)
                                                .setUnlockCascade(166),
                                        ...
                                        new KnowledgeFragmentItemConversion(134)
                                                .setItems(
                                                        new ItemStack(ItemList.instability_orb),
                                                        new ItemStack(ItemList.potion_of_instability))
                                                .setNonBuyableRedirect(INSTABILITY_ORB), // 741
                                        new KnowledgeFragmentItemConversion(135)
                                                .setItems(
                                                        new ItemStack(ItemList.silverfish_blood),
                                                        new ItemStack(ItemList.infestation_remedy))
                                                .setNonBuyableRedirect(SILVERFISH), // 731
                                        new KnowledgeFragmentItemConversion(136)
                                                .setItems(
                                                        new ItemStack(ItemList.ectoplasm),
                                                        new ItemStack(ItemList.potion_of_purity))
                                                .setNonBuyableRedirect(ECTOPLASM) // 951
                                }),

                        DRAGON_EGG.setPos(1, 8).setUnlockPrice(12).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(150).setPrice(5).setUnlockOnDiscovery()
                                                .setUnlockCascade(705),
                        ...
                        END_POWDER.setPos(8, 0).setUnlockPrice(20).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(160).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(161).setPrice(5).setUnlockOnDiscovery()
                                                .setUnlockRequirements(160),
                                        ...
                                        new KnowledgeFragmentText(166).setPrice(5).setUnlockRequirements(160)
                                                .setUnlockCascade(132),
                                        new KnowledgeFragmentText(167).setPrice(3).setUnlockCascade(244) }),

                        TEMPLE_CALLER.setPos(2, 12).setUnlockPrice(18).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        ENDER_DRAGON.setPos(1, 3).setUnlockPrice(20).setDiscoveryReward(55).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(190).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(191).setPrice(2).setUnlockOnDiscovery()
                                                .setUnlockRequirements(190).setUnlockCascade(751),
                                        ...
                                        new KnowledgeFragmentText(703).setPrice(2).setUnlockRequirements(196)
                                                .setUnlockCascade(210),
                                        new KnowledgeFragmentText(704).setPrice(2).setUnlockRequirements(190)
                                                .setUnlockCascade(81),
                                        new KnowledgeFragmentText(705).setPrice(2).setUnlockRequirements(704)
                                                .setUnlockCascade(150) }),

                        ANGRY_ENDERMAN.setPos(0, 5).setUnlockPrice(8).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        VAMPIRE_BAT.setPos(2, 5).setUnlockPrice(8).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(210).setPrice(5).setUnlockOnDiscovery()
                                                .setUnlockCascade(703),
                        ...
                        ENDER_PEARL_ENHANCEMENTS.setPos(11, 0).setUnlockPrice(8).setDiscoveryReward(10).addFragments(
                                KnowledgeUtils.createEnhancementFragments(
                        ...
                        ESSENCE_ALTAR_ENHANCEMENTS.setPos(11, 2).setUnlockPrice(10).setDiscoveryReward(10).addFragments(
                                KnowledgeUtils.createEnhancementFragments(
                        ...
                        ENHANCED_BREWING_STAND_ENHANCEMENTS.setPos(11, 4).setUnlockPrice(10).setDiscoveryReward(10)
                                .addFragments(
                                        KnowledgeUtils.createEnhancementFragments(
                                                EnhancedBrewingStandEnhancements.class,
                                                1500,
                                                4,
                                                10,
                                                new int[] { 160, 130 })),

                        TNT_ENHANCEMENTS.setPos(13, 0).setUnlockPrice(10).setDiscoveryReward(10).addFragments(
                                KnowledgeUtils.createEnhancementFragments(
                        ...
                        SPATIAL_DASH_GEM_ENHANCEMENTS.setPos(13, 2).setUnlockPrice(12).setDiscoveryReward(10)
                                .addFragments(
                                        KnowledgeUtils.createEnhancementFragments(
                        ...
                        TRANSFERENCE_GEM_ENHANCEMENTS.setPos(13, 4).setUnlockPrice(12).setDiscoveryReward(10)
                                .addFragments(
                                        KnowledgeUtils.createEnhancementFragments(
        ...
        KnowledgeCategories.ENDSTONE_BLOBS.addKnowledgeObjects(
                new KnowledgeObject[] {
                        ENDSTONE_BLOB.setCategoryObject(KnowledgeCategories.ENDSTONE_BLOBS).setUnlockPrice(40)
                                .setDiscoveryReward(10).addFragments(
                                        new KnowledgeFragment[] { new KnowledgeFragmentText(220).setPrice(5),
                                                ...
                                                new KnowledgeFragmentText(224).setPrice(5)
                                                        .setUnlockRequirements(221) }),

                        IGNEOUS_ROCK_ORE.setPos(0, 0).setUnlockPrice(10).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        DEATH_FLOWER.setPos(3, 0).setUnlockPrice(15).setDiscoveryReward(10)
                                .addFragments(
                                        new KnowledgeFragment[] {
                                                ...
                                                new KnowledgeFragmentText(244)
                                                        .setPrice(3).setUnlockRequirements(241).setUnlockCascade(167),
                                                new KnowledgeFragmentCrafting(245)
                                                        .setRecipe(
                                                                new ItemStack(Items.dye, 2, 13),
                                                                new ItemStack[] {
                                                                        new ItemStack(BlockList.death_flower, 1, 0) })
                                                        .setPrice(2).setUnlockRequirements(240),
                                                new KnowledgeFragmentCrafting(246)
                                                        .setRecipe(
                                                                new ItemStack(Items.dye, 2, 8),
                                                                new ItemStack[] {
                                                                        new ItemStack(BlockList.death_flower, 1, 15) })
                                                        .setPrice(2).setUnlockRequirements(243) }),

                        ENDER_GOO.setPos(6, 0).setUnlockPrice(8).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        IGNEOUS_ROCK.setPos(0, 2).setUnlockPrice(18).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        TRANSPORT_BEACON.setPos(9, 0).setUnlockPrice(20).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
        ...
        KnowledgeCategories.DUNGEON_TOWER.addKnowledgeObjects(
                new KnowledgeObject[] {
                        DUNGEON_TOWER.setCategoryObject(KnowledgeCategories.DUNGEON_TOWER).setUnlockPrice(55)
                                .setDiscoveryReward(25).addFragments(
                                        new KnowledgeFragment[] { new KnowledgeFragmentText(270).setPrice(5),
                                                ...
                                                new KnowledgeFragmentText(275).setPrice(2)
                                                        .setUnlockRequirements(272) }),

                        OBSIDIAN_STAIRS.setPos(3, 4).setUnlockPrice(1).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(280).setPrice(2).setUnlockOnDiscovery() }),

                        OBSIDIAN_SMOOTH.setPos(1, 0).setUnlockPrice(1).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(281).setPrice(1).setUnlockOnDiscovery() }),

                        OBSIDIAN_CHISELED.setPos(3, 0).setUnlockPrice(1).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(282).setPrice(1).setUnlockOnDiscovery() }),

                        OBSIDIAN_PILLAR.setPos(5, 0).setUnlockPrice(1).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(283).setPrice(1).setUnlockOnDiscovery() }),

                        OBSIDIAN_SMOOTH_GLOWING.setPos(1, 2).setUnlockPrice(1).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(284).setPrice(1).setUnlockOnDiscovery() }),

                        OBSIDIAN_CHISELED_GLOWING.setPos(3, 2).setUnlockPrice(1).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(285).setPrice(1).setUnlockOnDiscovery() }),

                        OBSIDIAN_PILLAR_GLOWING.setPos(5, 2).setUnlockPrice(1).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(286).setPrice(1).setUnlockOnDiscovery() }),

                        ENERGY.setPos(3, 16).setUnlockPrice(35).setDiscoveryReward(25).addFragments(
                                new KnowledgeFragment[] { new KnowledgeFragmentText(890).setPrice(8),
                        ...
                        ENDIUM_ORE.setPos(0, 12).setUnlockPrice(25).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(760).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(761).setPrice(8).setUnlockOnDiscovery()
                                                .setUnlockRequirements(760) }),

                        ENDIUM_BLOCK.setPos(4, 11).setUnlockPrice(5).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(770).setPrice(2).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(771)
                                                .setRecipe(new ItemStack(BlockList.endium_block)).setPrice(2)
                                                .setUnlockOnDiscovery().setUnlockRequirements(770)
                                                .setUnlockCascade(781),
                                        new KnowledgeFragmentCrafting(772)
                                                .setRecipe(new ItemStack(BlockList.void_chest))
                                                .setNonBuyableRedirect(VOID_CHEST), // 801
                                        new KnowledgeFragmentCrafting(773).setRecipe(new ItemStack(ItemList.blank_gem))
                                                .setNonBuyableRedirect(BLANK_GEM), // 1422
                                }),

                        VOID_CHEST.setPos(6, 11).setUnlockPrice(20).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(800).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(801)
                                                .setRecipe(new ItemStack(BlockList.void_chest)).setPrice(8)
                                                .setUnlockRequirements(800).setUnlockCascade(772),
                                        new KnowledgeFragmentText(802).setPrice(3).setUnlockRequirements(800) }),

                        SPATIAL_DASH_GEM.setPos(6, 7).setUnlockPrice(25).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(290).setPrice(5).setUnlockOnDiscovery()
                                                .setUnlockCascade(319),
                                        ...
                                        new KnowledgeFragmentCrafting(295)
                                                .setRecipe(new ItemStack(ItemList.spatial_dash_gem))
                                                .setNonBuyableRedirect(ARCANE_SHARD) // 1423
                                }),

                        ENDIUM_INGOT.setPos(2, 12).setUnlockPrice(30).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(780).setPrice(2).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(781)
                                                .setRecipe(new ItemStack(BlockList.endium_block)).setPrice(2)
                                                .setUnlockOnDiscovery().setUnlockRequirements(780)
                                                .setUnlockCascade(771),
                                        new KnowledgeFragmentCrafting(782)
                                                .setRecipe(new ItemStack(ItemList.biome_compass))
                                                .setNonBuyableRedirect(BIOME_COMPASS) // 303
                                }),

                        BIOME_COMPASS.setPos(4, 13).setUnlockPrice(25).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(300).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(301).setPrice(5).setUnlockOnDiscovery()
                                                .setUnlockRequirements(300),
                                        new KnowledgeFragmentText(302).setPrice(3).setUnlockRequirements(301),
                                        new KnowledgeFragmentCrafting(303)
                                                .setRecipe(new ItemStack(ItemList.biome_compass)).setPrice(8)
                                                .setUnlockRequirements(300).setUnlockCascade(782) }),

                        ENDER_EYE.setPos(3, 7).setUnlockPrice(20).setDiscoveryReward(32).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(310).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(311).setPrice(2).setUnlockOnDiscovery()
                                                .setUnlockRequirements(310),
                                        ...
                                        new KnowledgeFragmentText(319).setPrice(3).setUnlockRequirements(310)
                                                .setUnlockCascade(290) }),

                        ANGRY_ENDERMAN_LINKED.setPos(0, 7) });

        // ===

        KnowledgeCategories.METEOROIDS.addKnowledgeObjects(
                new KnowledgeObject[] {
                        METEOROID.setCategoryObject(KnowledgeCategories.METEOROIDS).setUnlockPrice(40)
                                .setDiscoveryReward(8)
                                .addFragments(new KnowledgeFragment[] { new KnowledgeFragmentText(320).setPrice(7) }),

                        SPHALERITE.setPos(0, 0).setUnlockPrice(12).setDiscoveryReward(6).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(330).setPrice(4).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(331).setPrice(4).setUnlockOnDiscovery()
                                                .setUnlockRequirements(330) }),

                        SPHALERITE_WITH_STARDUST.setPos(2, 2).setUnlockPrice(12).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        STARDUST.setPos(4, 4).setUnlockPrice(20).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(350).setPrice(4).setUnlockOnDiscovery() }),

                        DECOMPOSITION_TABLE.setPos(5, 7).setUnlockPrice(12).setDiscoveryReward(6).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(880).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(881)
                                                .setRecipe(new ItemStack(BlockList.decomposition_table)).setPrice(10)
                                                .setUnlockRequirements(880),
                        ...
                        EXPERIENCE_TABLE.setPos(7, 7).setUnlockPrice(12).setDiscoveryReward(6).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(970).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(971)
                                                .setRecipe(new ItemStack(BlockList.experience_table)).setPrice(10)
                                                .setUnlockRequirements(970),
                        ...
                        ACCUMULATION_TABLE.setPos(5, 9).setUnlockPrice(18).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(980).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(981)
                                                .setRecipe(new ItemStack(BlockList.accumulation_table)).setPrice(10)
                                                .setUnlockRequirements(980),
                        ...
                        EXTRACTION_TABLE.setPos(7, 9).setUnlockPrice(18).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(990).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(991)
                                                .setRecipe(new ItemStack(BlockList.extraction_table)).setPrice(10)
                                                .setUnlockRequirements(990),
        ...
        KnowledgeCategories.BIOME_ISLANDS.addKnowledgeObjects(
                new KnowledgeObject[] {
                        BIOME_ISLANDS.setCategoryObject(KnowledgeCategories.BIOME_ISLANDS).setUnlockPrice(50)
                                .setDiscoveryReward(20).addFragments(
                                        new KnowledgeFragment[] { new KnowledgeFragmentText(720).setPrice(7),
                                                ...
                                                new KnowledgeFragmentText(723).setPrice(4)
                                                        .setUnlockRequirements(721) }),

                        INSTABILITY_ORB_ORE.setPos(0, 3).setUnlockPrice(15).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        STARDUST_ORE.setPos(0, 0).setUnlockPrice(15).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        INSTABILITY_ORB.setPos(2, 3).setUnlockPrice(20).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        POTION_OF_INSTABILITY
                                .setPos(4, 3).setUnlockPrice(
                                        15)
                                .setDiscoveryReward(8).addFragments(
                                        new KnowledgeFragment[] {
                                                new KnowledgeFragmentText(740).setPrice(7).setUnlockOnDiscovery(),
                                                new KnowledgeFragmentItemConversion(741)
                                                        .setItems(
                                                                new ItemStack(ItemList.instability_orb),
                                                                new ItemStack(ItemList.potion_of_instability))
                                                        .setPrice(3).setUnlockRequirements(740)
                                                        .setUnlockCascade(134, 383) }),

                        STARDUST_LINKED.setPos(2, 0) });

        // ===

        KnowledgeCategories.BIOME_ISLAND_FOREST.addKnowledgeObjects(
                new KnowledgeObject[] { INFESTED_FOREST_BIOME.setCategoryObject(KnowledgeCategories.BIOME_ISLAND_FOREST)
                        .setUnlockPrice(60).setDiscoveryReward(45).addFragments(
                                new KnowledgeFragment[] { new KnowledgeFragmentText(390).setPrice(7),
                        ...
                        INFESTED_END_STONE.setPos(0, 0).setUnlockPrice(7).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(400).setPrice(2).setUnlockOnDiscovery() }),

                        INFESTED_GRASS.setPos(2, 0).setUnlockPrice(2).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(410).setPrice(2).setUnlockOnDiscovery() }),

                        INFESTED_TALL_GRASS.setPos(4, 0).setUnlockPrice(2).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(411).setPrice(2).setUnlockOnDiscovery() }),

                        INFESTED_FERN.setPos(6, 0).setUnlockPrice(2).setDiscoveryReward(3).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(412).setPrice(2).setUnlockOnDiscovery() }),

                        INFESTATION_REMEDY.setPos(4, 2).setUnlockPrice(12).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(730).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentItemConversion(731)
                                                .setItems(
                                                        new ItemStack(ItemList.silverfish_blood),
                                                        new ItemStack(ItemList.infestation_remedy))
                                                .setPrice(2).setUnlockRequirements(730).setUnlockCascade(135), }),

                        INFESTED_BAT.setPos(2, 2).setUnlockPrice(8).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        THORNY_BUSH.setPos(0, 7).setUnlockPrice(8).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        SPOOKY_LOG.setPos(2, 8).setUnlockPrice(25).setDiscoveryReward(22).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentText(432).setPrice(7).setUnlockRequirements(430)
                                                .setUnlockCascade(451),
                                        ...
                                        new KnowledgeFragmentText(436).setPrice(10).setUnlockRequirements(435)
                                                .setUnlockCascade(461),
                                        new KnowledgeFragmentCrafting(437)
                                                .setRecipe(new ItemStack(BlockList.spooky_log)).setPrice(5)
                                                .setUnlockRequirements(430).setUnlockCascade(452) }),

                        SPOOKY_LEAVES.setPos(2, 6).setUnlockPrice(12).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentCrafting(442)
                                                .setRecipe(new ItemStack(BlockList.spooky_leaves)).setPrice(5)
                                                .setUnlockRequirements(440).setUnlockCascade(453) }),

                        DRY_SPLINTER.setPos(4, 7).setUnlockPrice(15).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(450).setPrice(2).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(451).setPrice(3).setUnlockRequirements(450)
                                                .setUnlockCascade(432),
                                        new KnowledgeFragmentCrafting(452)
                                                .setRecipe(new ItemStack(BlockList.spooky_log)).setPrice(5)
                                                .setUnlockRequirements(450).setUnlockCascade(437),
                                        new KnowledgeFragmentCrafting(453)
                                                .setRecipe(new ItemStack(BlockList.spooky_leaves)).setPrice(5)
                                                .setUnlockRequirements(450).setUnlockCascade(442) }),

                        GHOST_AMULET.setPos(7, 7).setUnlockPrice(24).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(460).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(461).setPrice(10).setUnlockRequirements(460)
                                                .setUnlockCascade(436),
                                        new KnowledgeFragmentText(462).setPrice(10).setUnlockRequirements(460),
                                        new KnowledgeFragmentText(463).setPrice(7).setUnlockRequirements(462)
                                                .setUnlockCascade(117) }),

                        ECTOPLASM.setPos(9, 7).setUnlockPrice(35).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(470).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(471)
                                                .setRecipe(new ItemStack(ItemList.spectral_tear))
                                                .setNonBuyableRedirect(SPECTRAL_TEAR) // 921
                                }),

                        SPECTRAL_TEAR.setPos(9, 9).setUnlockPrice(10).setDiscoveryReward(6).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(920).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(921)
                                                .setRecipe(new ItemStack(ItemList.spectral_tear)).setPrice(7)
                                                .setUnlockRequirements(920).setUnlockCascade(471),
                                        new KnowledgeFragmentCrafting(922)
                                                .setRecipe(new ItemStack(ItemList.living_matter))
                                                .setNonBuyableRedirect(LIVING_MATTER) // 931
                                }),

                        LIVING_MATTER.setPos(11, 9).setUnlockPrice(20).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(930).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(931)
                                                .setRecipe(new ItemStack(ItemList.living_matter)).setPrice(10)
                                                .setUnlockRequirements(930).setUnlockCascade(922) }),

                        CURSE.setPos(13, 9).setUnlockPrice(40).setDiscoveryReward(15)
                                .addFragments(
                                        new KnowledgeFragment[] {
                        ...
                        POTION_OF_PURITY.setPos(15, 8).setUnlockPrice(15).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(950).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(951).setPrice(5).setUnlockRequirements(950)
                                                .setUnlockCascade(136) }),

                        CURSE_AMULET.setPos(15, 10).setUnlockPrice(10).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        RAVAGED_DUNGEON.setPos(4, 13).setUnlockPrice(30).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] { new KnowledgeFragmentText(490).setPrice(7),
                        ...
                        RAVAGED_BRICK.setPos(4, 15).setUnlockPrice(10).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentCrafting(502)
                                                .setRecipe(new ItemStack(BlockList.ravaged_brick_stairs, 4)).setPrice(4)
                                                .setUnlockRequirements(500).setUnlockCascade(513),
                                        new KnowledgeFragmentCrafting(503)
                                                .setRecipe(new ItemStack(BlockList.ravaged_brick_slab, 6)).setPrice(4)
                                                .setUnlockRequirements(500).setUnlockCascade(515),
                                        new KnowledgeFragmentCrafting(504)
                                                .setRecipe(new ItemStack(BlockList.ravaged_brick_fence, 6)).setPrice(4)
                                                .setUnlockRequirements(500).setUnlockCascade(517) }),

                        RAVAGED_BRICK_GLOWING.setPos(6, 15).setUnlockPrice(2).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(510).setPrice(5).setUnlockOnDiscovery() }),

                        RAVAGED_BRICK_STAIRS.setPos(2, 15).setUnlockPrice(2).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(512).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(513)
                                                .setRecipe(new ItemStack(BlockList.ravaged_brick_stairs, 4)).setPrice(4)
                                                .setUnlockRequirements(512).setUnlockCascade(502) }),

                        RAVAGED_BRICK_SLAB.setPos(0, 15).setUnlockPrice(2).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(514).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(515)
                                                .setRecipe(new ItemStack(BlockList.ravaged_brick_slab, 6)).setPrice(4)
                                                .setUnlockRequirements(514).setUnlockCascade(503) }),

                        RAVAGED_BRICK_FENCE.setPos(8, 15).setUnlockPrice(2).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(516).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(517)
                                                .setRecipe(new ItemStack(BlockList.ravaged_brick_fence, 6)).setPrice(4)
                                                .setUnlockRequirements(516).setUnlockCascade(504) }),

                        CHARM_POUCH.setPos(7, 18).setUnlockPrice(40).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        RUNES.setPos(3, 18).setUnlockPrice(25).setDiscoveryReward(18).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentCrafting(533)
                                                .setRecipe(new ItemStack(ItemList.charm_pouch))
                                                .setNonBuyableRedirect(CHARM_POUCH) // 521
                                }),

                        CHARMS.setPos(5, 18).setUnlockPrice(35).setDiscoveryReward(25)
                                .addFragments(
                                        new KnowledgeFragment[] {
                        ...
                        LOUSE.setPos(1, 18).setUnlockPrice(15).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
        ...
        KnowledgeCategories.BIOME_ISLAND_MOUNTAINS.addKnowledgeObjects(
                new KnowledgeObject[] {
                        BURNING_MOUNTAINS_BIOME.setCategoryObject(KnowledgeCategories.BIOME_ISLAND_MOUNTAINS)
                                .setUnlockPrice(60).setDiscoveryReward(45).addFragments(
                                        new KnowledgeFragment[] { new KnowledgeFragmentText(560).setPrice(7),
                                                ...
                                                new KnowledgeFragmentText(563).setPrice(15)
                                                        .setUnlockRequirements(561) }),

                        BURNED_END_STONE.setPos(0, 0).setUnlockPrice(5).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(570).setPrice(2).setUnlockOnDiscovery() }),

                        FLAMEWEED_1.setPos(5, 0).setUnlockPrice(3).setDiscoveryReward(4).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(582).setPrice(4).setUnlockOnDiscovery() }),

                        FLAMEWEED_2.setPos(7, 0).setUnlockPrice(3).setDiscoveryReward(4)
                                .addFragments(new KnowledgeFragment[] { FLAMEWEED_1.getFragments().iterator().next() }),

                        FLAMEWEED_3.setPos(9, 0).setUnlockPrice(3).setDiscoveryReward(4)
                                .addFragments(new KnowledgeFragment[] { FLAMEWEED_1.getFragments().iterator().next() }),
                        ...
                        CINDER.setPos(0, 7).setUnlockPrice(5).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(590).setPrice(5).setUnlockOnDiscovery() }),

                        LILYFIRE.setPos(13, 7).setUnlockPrice(4).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(580).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(581)
                                                .setRecipe(
                                                        new ItemStack(Items.dye, 2, 14),
                                                        new ItemStack[] { new ItemStack(
                                                                BlockList.crossed_decoration,
                                                                1,
                                                                BlockCrossedDecoration.dataLilyFire) })
                                                .setPrice(4).setUnlockRequirements(580) }),

                        DUNGEON_PUZZLE.setPos(10, 7).setUnlockPrice(15).setDiscoveryReward(25).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        FIERY_ESSENCE_ALTAR.setPos(5, 9).setUnlockPrice(25).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        FIRE_GOLEM.setPos(2, 6).setUnlockPrice(20).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentText(614).setPrice(5).setUnlockRequirements(610)
                                                .setUnlockCascade(82) }),

                        SCORCHING_LENS.setPos(2, 8).setUnlockPrice(20).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentText(623).setPrice(5).setUnlockRequirements(620)
                                                .setUnlockCascade(82) }),

                        FIRE_FIEND.setPos(8, 7).setUnlockPrice(30).setDiscoveryReward(18).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        INFERNIUM.setPos(2, 13).setUnlockPrice(15).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(630).setPrice(7).setUnlockOnDiscovery()
                                                .setUnlockCascade(657),
                                        new KnowledgeFragmentCrafting(631)
                                                .setRecipe(new ItemStack(ItemList.scorching_pickaxe))
                                                .setNonBuyableRedirect(SCORCHING_PICKAXE) // 643
                                }),

                        SCORCHING_PICKAXE.setPos(4, 13).setUnlockPrice(40).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentCrafting(643)
                                                .setRecipe(new ItemStack(ItemList.scorching_pickaxe)).setPrice(10)
                                                .setUnlockRequirements(640).setUnlockCascade(631) }),
                        ...
                        HAUNTED_MINER.setPos(0, 13).setUnlockPrice(25).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentText(657).setPrice(5).setUnlockRequirements(650)
                                                .setUnlockCascade(630) }) });

        KnowledgeCategories.BIOME_ISLAND_ENCHISLAND.addKnowledgeObjects(
                new KnowledgeObject[] {
                        ENCHANTED_ISLAND_BIOME.setCategoryObject(KnowledgeCategories.BIOME_ISLAND_ENCHISLAND)
                                .setUnlockPrice(60).setDiscoveryReward(45).addFragments(
                                        new KnowledgeFragment[] { new KnowledgeFragmentText(660).setPrice(5),
                                                ...
                                                new KnowledgeFragmentText(665).setPrice(7).setUnlockRequirements(661)
                                                        .setUnlockCascade(810) }),

                        ENCHANTED_END_STONE.setPos(0, 0).setUnlockPrice(5).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(670).setPrice(2).setUnlockOnDiscovery() }),

                        FALLING_OBSIDIAN_LINKED.setPos(2, 0),

                        PERSEGRIT.setPos(4, 0).setUnlockPrice(7).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(810).setPrice(5).setUnlockOnDiscovery()
                                                .setUnlockCascade(665),
                        ...
                        ARCANE_SHARD.setPos(5, 6).setUnlockPrice(28).setDiscoveryReward(27).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(1420).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentText(1421).setPrice(2),
                                        new KnowledgeFragmentCrafting(1422).setRecipe(new ItemStack(ItemList.blank_gem))
                                                .setPrice(5).setUnlockCascade(773, 1431),
                                        new KnowledgeFragmentCrafting(1423)
                                                .setRecipe(new ItemStack(ItemList.spatial_dash_gem)).setPrice(7)
                                                .setUnlockCascade(295),
                                        new KnowledgeFragmentCrafting(1424)
                                                .setRecipe(new ItemStack(ItemList.transference_gem)).setPrice(7)
                                                .setUnlockCascade(1441) }),

                        BLANK_GEM.setPos(7, 6).setUnlockPrice(15).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(1430).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(1431).setRecipe(new ItemStack(ItemList.blank_gem))
                                                .setNonBuyableRedirect(ARCANE_SHARD), // 1422
                                }),

                        SPATIAL_DASH_GEM_LINKED.setPos(9, 6),

                        TRANSFERENCE_GEM.setPos(11, 6).setUnlockPrice(20).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(1440).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(1441)
                                                .setRecipe(new ItemStack(ItemList.transference_gem))
                                                .setNonBuyableRedirect(ARCANE_SHARD), // 1424
                        ...
                        BABY_ENDERMAN.setPos(0, 6).setUnlockPrice(25).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        HOMELAND_ENDERMAN.setPos(2, 6).setUnlockPrice(25).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        LABORATORY.setPos(3, 10).setUnlockPrice(30).setDiscoveryReward(20).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        LABORATORY_OBSIDIAN.setPos(0, 12).setUnlockPrice(5).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(1450).setPrice(4).setUnlockOnDiscovery() }),

                        LABORATORY_GLASS.setPos(2, 12).setUnlockPrice(5).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(1451).setPrice(4).setUnlockOnDiscovery() }),

                        LABORATORY_FLOOR.setPos(4, 12).setUnlockPrice(5).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(1452).setPrice(4).setUnlockOnDiscovery() }),

                        LABORATORY_STAIRS.setPos(6, 12).setUnlockPrice(5).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(1453).setPrice(4).setUnlockOnDiscovery() }),

                        OBSIDIAN_FRAGMENT.setPos(2, 15).setUnlockPrice(15).setDiscoveryReward(10).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(820).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(821)
                                                .setRecipe(new ItemStack(ItemList.obsidian_rod))
                                                .setNonBuyableRedirect(OBSIDIAN_ROD), // 831
                                        new KnowledgeFragmentCrafting(822).setRecipe(new ItemStack(Blocks.obsidian))
                                                .setPrice(5).setUnlockRequirements(820),
                                        new KnowledgeFragmentCrafting(823)
                                                .setRecipe(new ItemStack(BlockList.obsidian_special, 1, 0)).setPrice(4)
                                                .setUnlockRequirements(822),
                                        new KnowledgeFragmentCrafting(824)
                                                .setRecipe(new ItemStack(BlockList.obsidian_special, 1, 1)).setPrice(4)
                                                .setUnlockRequirements(822),
                                        new KnowledgeFragmentCrafting(825)
                                                .setRecipe(new ItemStack(BlockList.obsidian_special, 1, 2)).setPrice(4)
                                                .setUnlockRequirements(822), }),

                        OBSIDIAN_ROD.setPos(4, 15).setUnlockPrice(7).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(830).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(831)
                                                .setRecipe(new ItemStack(ItemList.obsidian_rod)).setPrice(5)
                                                .setUnlockRequirements(830).setUnlockCascade(821),
                                        new KnowledgeFragmentCrafting(832)
                                                .setRecipe(new ItemStack(ItemList.energy_wand))
                                                .setNonBuyableRedirect(ENERGY_WAND) // 851
                                }),

                        AURICION.setPos(12, 15).setUnlockPrice(7).setDiscoveryReward(12).addFragments(
                                new KnowledgeFragment[] {
                                        ...
                                        new KnowledgeFragmentCrafting(872)
                                                .setRecipe(new ItemStack(ItemList.energy_wand_core)).setPrice(7)
                                                .setUnlockRequirements(870).setUnlockCascade(841) }),

                        ENERGY_WAND_CORE.setPos(10, 15).setUnlockPrice(7).setDiscoveryReward(5).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(840).setPrice(5).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(841)
                                                .setRecipe(new ItemStack(ItemList.energy_wand_core)).setPrice(7)
                                                .setUnlockRequirements(840).setUnlockCascade(872),
                                        new KnowledgeFragmentCrafting(842)
                                                .setRecipe(new ItemStack(ItemList.energy_wand))
                                                .setNonBuyableRedirect(ENERGY_WAND) // 851
                                }),

                        ENERGY_WAND.setPos(7, 15).setUnlockPrice(35).setDiscoveryReward(8).addFragments(
                                new KnowledgeFragment[] {
                                        new KnowledgeFragmentText(850).setPrice(7).setUnlockOnDiscovery(),
                                        new KnowledgeFragmentCrafting(851)
                                                .setRecipe(new ItemStack(ItemList.energy_wand)).setPrice(10)
                                                .setUnlockRequirements(850).setUnlockCascade(832, 842),
                        ...
                        ENDER_GUARDIAN.setPos(0, 15).setUnlockPrice(20).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
                        ...
                        ENDERMAGE.setPos(14, 15).setUnlockPrice(20).setDiscoveryReward(15).addFragments(
                                new KnowledgeFragment[] {
        ...
        if (Log.isDebugEnabled()) {
            ...
            for (KnowledgeCategory category : KnowledgeCategories.categoryList) {
                if (category.getCategoryObject() == null) throw new IllegalStateException(
                        "Knowledge Category " + category.getTooltip() + " has null category object!");
            }

            int amtObjects = 0, amtFragments = 0, totalObjPrice = 0, totalFragPrice = 0, totalFragPriceExcCascaded = 0,
                    totalFragPriceExcDiscovery = 0, totalReward = 0;
            TIntHashSet cascaded = new TIntHashSet();

            for (KnowledgeObject<?> obj : KnowledgeObject.getAllObjects()) {
                if (obj == HELP) continue;
                else if (obj.getDiscoveryReward() == 0 || obj.getUnlockPrice() == 0) throw new IllegalStateException(
                        "Knowledge Object " + obj.globalID
                                + "/"
                                + obj.getUnlocalizedTooltip()
                                + " has illegal reward ("
                                + obj.getDiscoveryReward()
                                + ") or unlock price ("
                                + obj.getUnlockPrice()
                                + ").");

                for (KnowledgeFragment fragment : obj.getFragments()) {
                    if (fragment.getPrice() == 0) throw new IllegalStateException(
                            "Knowledge Fragment " + fragment.globalID + " has illegal unlock price.");
                    ...
                    for (int id : fragment.getUnlockRequirements()) {
                        if (KnowledgeFragment.getById(id) == null) throw new IllegalStateException(
                                "Knowledge Fragment " + fragment.globalID
                                        + " has invalid unlock requirement ID "
                                        + id
                                        + ".");
                    }
            ...
            for (IEnhancementEnum enhancement : EnhancementHandler.getAllEnhancements()) {
                if (KnowledgeFragmentEnhancement.getEnhancementFragment(enhancement) == null)
                    throw new IllegalStateException("Enhancement is missing a fragment: " + enhancement);
            }
            ...
            Log.debug(
                    "Total Fragment price, excluding all: $0",
                    totalFragPriceExcCascaded - (totalFragPrice - totalFragPriceExcDiscovery));
            Log.debug(
                    "Total real price: $0",
                    totalObjPrice + totalFragPriceExcCascaded - (totalFragPrice - totalFragPriceExcDiscovery));
    ...
    public static KnowledgeObject<? extends IKnowledgeObjectInstance<?>> link(
            KnowledgeObject<? extends IKnowledgeObjectInstance<?>> object) {
        return new LinkedKnowledgeObject<>(object);
    }

    public static KnowledgeObject<? extends IKnowledgeObjectInstance<?>> link(
            KnowledgeObject<? extends IKnowledgeObjectInstance<?>> object, ItemStack itemToRender, String tooltip) {
