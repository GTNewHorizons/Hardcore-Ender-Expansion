...
public class RenderTileVoidChest extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
            "hardcoreenderexpansion:textures/entity/tile/void_chest.png");
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTickTime) {
        ...
        model.chestLid.rotateAngleX = -((1F
                - (float) Math.pow(1F - chest.lidAnim + (chest.prevLidAnim - chest.lidAnim) * partialTickTime, 3))
                * (float) Math.PI
                * 0.5F);
        model.renderAll();
