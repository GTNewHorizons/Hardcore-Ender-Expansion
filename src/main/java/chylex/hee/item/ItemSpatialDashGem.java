...
public class ItemSpatialDashGem extends ItemAbstractEnergyAcceptor {
        ...
        if (is.getItemDamage() < is.getMaxDamage()
            ...
            if (!world.isRemote) {
                ...
                world.spawnEntityInWorld(
                        new EntityProjectileSpatialDash(world, player, EnhancementHandler.getEnhancements(is)));
                ...
                ItemUtil.getTagRoot(is, true).setByte("cooldown", (byte) 18);
                    ...
                    player.posY,
                    player.posZ,
                    "hardcoreenderexpansion:player.random.spatialdash",
                    0.8F,
                    0.9F,
                    false);
        }
    ...
    public int getColorFromItemStack(ItemStack is, int pass) {
        return ItemUtil.getTagRoot(is, false).hasKey("cooldown") ? (192 << 16 | 192 << 8 | 192)
