...
public final class CustomMusicTicker extends MusicTicker {
    ...
    static {
        ...
        HEE_END = EnumHelper.addEnum(
                enumClasses,
                MusicType.class,
                "HEE_END",
                new ResourceLocation("hardcoreenderexpansion:music.game.end"),
                3600,
                8400);
        HEE_END_DRAGON_CALM = EnumHelper.addEnum(
                enumClasses,
                MusicType.class,
                "HEE_END_DRAGON_CALM",
                new ResourceLocation("hardcoreenderexpansion:music.game.end.dragoncalm"),
                0,
                0);
        HEE_END_DRAGON_ANGRY = EnumHelper.addEnum(
                enumClasses,
                MusicType.class,
                "HEE_END_DRAGON_ANGRY",
                new ResourceLocation("hardcoreenderexpansion:music.game.end.dragonangry"),
                0,
                0);
    }
